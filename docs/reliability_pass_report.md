...
| `tau_adapt` (aspect ratio / area) | **9.0 h** (`config.tau_adapt_hours`, Table-1 nominal midpoint of 6–12 h; **never overridden** in any configured run) |
